...
// First submission triggers a one-time verification email at this address.
const FORMSUBMIT_ENDPOINT = "https://formsubmit.co/ajax/kateyelinam@gmail.com";
  ...
  return (
    ...
    >
      <div className="container-wide">
        ...
        <div
          style={{ display: "grid", gridTemplateColumns: "minmax(0,1fr) minmax(0,1.6fr)", gap: 80 }}
            ...
            <div>
              ...
              <div style={{ marginBottom: 28 }}>
                ...
                <a
                  ...
                  className="font-display"
                  style={{ fontSize: 22, color: "var(--text-0)", textDecoration: "none" }}
              ...
              >
                ...
                {sent && (
                  ...
                  >
                    ...
                    <span
                      className="font-mono"
                      style={{ fontSize: 11, textTransform: "uppercase", letterSpacing: "0.18em" }}
                    >
                      Sent — talk soon
                    </span>
                  </span>
